...
function App() {
  ...
  return (
  <main className={`relative overflow-clip w-full h-full bg-[url('/BG.svg')] bg-cover bg-no-repeat`}>
    <div className={`absolute w-full h-full`}>
      {/* Card for Background */}
      <div className={`w-full absolute top-45/100 left-70/100 origin-bottom-left rotate-5 z-0`}>
        <Card />
      </div>
